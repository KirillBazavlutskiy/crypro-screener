import {
    ...
    CrossHairCursor, EdgeIndicator, MouseCoordinateY,
    ...
    return (
        ...
        >
            ...
            <Chart id={1} yExtents={(d: CandleStickData) => [d.high, d.low]}>
                ...
                />
                {
                    solidityInfo?.solidity?.price &&
                    <PriceCoordinate
                        price={solidityInfo.solidity.price}
                        fill={'#fff'}
                        lineStroke={'#fff'}
                        orient={"left"}
                        textFill={'#000'}
                        stroke={'#000'}
                        rectWidth={solidityInfo.solidity.price.toString().length * 8}
                        yAxisPad={20}
                        at={'left'}
                        dx={solidityInfo.solidity.price.toString().length * 8}
                        arrowWidth={5}
                        rectHeight={13}
                        lineOpacity={50}
                    />
